...
function buildClinicalFocusRule(subject) {
  ...
  if (isBasic) return "";
  return `ЖЁСТКИЙ ЗАПРЕТ — эти шаблоны вопросов КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНЫ даже с клиническим контекстом:
✗ «Какой маркер/показатель/признак/тест наиболее важен/характерен/специфичен для...»
✗ «Какой лабораторный/инструментальный метод наиболее точно/убедительно...»
✗ «Перечислите/Назовите/Укажите [критерии/маркеры/показатели/признаки]»
✗ «Что является основным критерием диагностики...»
✗ Любой вопрос, ответ на который — название анализа, маркера, метода или признака.

ОБЯЗАТЕЛЬНЫЕ шаблоны (каждый вопрос должен заканчиваться одним из):
✓ «...Ваш предварительный диагноз?»
✓ «...Какова наиболее вероятная причина состояния?»
✓ «...Какова Ваша тактика ведения?»
✓ «...Какое лечение показано в первую очередь?»
✓ «...Какое осложнение наиболее вероятно?»
✓ «...Чем обусловлена данная клиническая картина?»
✓ «...Каков механизм развития данного симптома?»
✓ «...С каким заболеванием необходимо провести дифференциальную диагностику в первую очередь?»

ПРАВИЛЬНАЯ структура вопроса:
[Описание пациента: возраст, симптомы, данные] → [Врачебный вопрос из списка выше]

ПРИМЕРЫ ПРАВИЛЬНЫХ вопросов:
✓ «У новорождённого на 2-е сутки нарастающая желтуха, вялость, гемоглобин 100 г/л. Ваш предварительный диагноз?»
✓ «Ребёнок 5 лет поступил с петехиями на коже и носовым кровотечением после ОРВИ. Какова Ваша тактика ведения?»
✓ «У ребёнка 3 лет с менингеальными симптомами и температурой 39°C ликвор мутный. Ваш предварительный диагноз?»`;
}
